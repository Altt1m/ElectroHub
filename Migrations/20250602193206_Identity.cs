    ...
    public partial class Identity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnouncementExchanges", x => new { x.AnnouncementId, x.ExchangeOfferId });
                    table.ForeignKey(
                        name: "FK_AnnouncementExchanges_Announcements_AnnouncementId",
                        column: x => x.AnnouncementId,
                        principalTable: "Announcements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnnouncementExchanges_ExchangeOffers_ExchangeOfferId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnnouncementExchanges_ExchangeOfferId",
                table: "AnnouncementExchanges",
